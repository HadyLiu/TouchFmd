...
#define QT_CH0_THRESH 20u                              /* 标称差量；MIN/HYST 由此算出 */
...
#define QT_CH0_RECAL_JUMP 50u                          /* 空闲 S 突升重校准 */
#define QT_CH0_PRESS_TIMEOUT 2000u                     /* 长按超时扫描次数 */

/* CH1 独立参数 */
#define QT_CH1_THRESH 20u                              /* 标称差量；MIN/HYST 由此算出 */
...
#define QT_CH1_RECAL_JUMP 50u                          /* 空闲 S 突升重校准 */
